...
extern json_spirit::Value omni_getupdate(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value omni_searchupdate(const json_spirit::Array& params, bool fHelp);
