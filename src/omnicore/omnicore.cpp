 ...
 */
int64_t GetDevOmni(int64_t nTime)
{
 ...
 *
 * @param nTime  The timestamp of the block to update the "Dev Omni" for
 * @param nBlock The block height
 * @return The number of "Dev Omni" generated
 */
static int64_t calculate_and_update_devmsc(int64_t nTime, int nBlock)
{
    const int64_t all_reward = 5631623576222;
    ...
    NotifyTotalTokensChanged(OMNI_PROPERTY_MSC, nBlock);
